...
BEGIN
	...
	BEGIN
		...
		R.IdStage, R.Estatus EstatusEtapaProceso,CAST(E.Stage as varchar) Orden, E.Concepto NombreEtapa, CAST(E.PorcentajeAsignado as varchar) Probabilidad
	...
	BEGIN
		...
		END
		/*
		INSERT INTO RelacionProcesoStage (IdProceso,IdStage,Estatus)
		SELECT @vIdNuevoProceso, IdStage, Estatus
