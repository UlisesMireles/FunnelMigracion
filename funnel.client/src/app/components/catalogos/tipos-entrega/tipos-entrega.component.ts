...
export class TiposEntregaComponent {
  ...
  constructor(private tipoEntregaService: TipoEntregaService, private messageService: MessageService,
  ...
  ngOnInit(): void {
    this.configuracionColumnasService.obtenerColumnasAMostrar(EnumTablas.TipoEntrega).subscribe({
      next: ({ todas, mostrar }) => {
