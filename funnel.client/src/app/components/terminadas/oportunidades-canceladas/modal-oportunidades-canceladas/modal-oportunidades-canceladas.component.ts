...
@Component({
  selector: 'app-modal-oportunidades-canceladas',
  standalone: false,
  templateUrl: './modal-oportunidades-canceladas.component.html',
  styleUrl: './modal-oportunidades-canceladas.component.css'
})
export class ModalOportunidadesCanceladasComponent {
